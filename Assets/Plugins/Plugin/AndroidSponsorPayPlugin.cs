...
namespace SponsorPay
{
	...
	public class AndroidSponsorPayPlugin : ISponsorPayPlugin
	{
		...
		{
			SPOfferWall.Call("launchOfferWall", credentialsToken, currencyName);
		}

		public void RequestNewCoins(string credentialsToken, string currencyName)
		{
			SPCurrency.Call("requestNewCoins", credentialsToken, currencyName);
		}
		...
		{
			SPBrandEngage.Call("requestOffers", credentialsToken, currencyName, queryVCS);
		}
		...
		{
			SPInterstitial.Call("requestAds", credentialsToken);
		}
